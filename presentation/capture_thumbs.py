...
PLAN = [
    ...
    (11, "slideQuestionsAgentIdentity", None),
    (12, "slideHeroStytch", None),
    (13, "slideProblemStytch", None),
    (14, "slidePersonaStytch", None),
    (15, "demoSlide", None),
    (16, "demoSelectSlide", None),
    (17, "slideSolution", None),
    (18, "journeySlide-1", 1),
    (18, "journeySlide-2", 2),
    (18, "journeySlide-3", 3),
    (18, "journeySlide-4", 4),
    (19, "slideChallengesStytch", None),
    (20, "slideImpact", None),
    (21, "slideThankYou", None),
]
